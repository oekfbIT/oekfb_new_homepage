      ...
      {screenWidth < 900 && (
        <>
          <NavigationDesktop
            ...
            mobileBurgerMenu="/img/mobile-burger-menu-8.svg"
            navRowWrapper="/img/nav-row-wrapper-content-logo-8.svg"
          />
          ...
          <div className="page-content">
            <div className="leagues-wrapper">
              <Dropdown className="instance-node-2" />
                  ...
                  <div className="page-header-3">
                    <div className="page-header-wrapper-2">
                      ...
                      <p className="page-header-wrapper-4">
                        ...
                        Cras nec varius lorem, eget faucibus ex. Vivamus
                        vehicula dui non leo laoreet luctus. Etiam congue
                        consequat placerat.
                      </p>
                    </div>
                  </div>
          ...
          <div className="page-content-2">
            <div className="div-14">
              <div className="leagues-wrapper-2">
                <Dropdown className="instance-node" />
